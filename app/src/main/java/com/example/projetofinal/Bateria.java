...
public class Bateria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        porcentagem = findViewById(R.id.textView6);
        status = findViewById(R.id.textView7);
        saude = findViewById(R.id.textView8);
    ...
    public void checkBatteryChargeTime() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            if (pluged == 0) {                                          //TODO: Valor de 60000 para os demais aparelhos
                status.setText("Dispositivo não está carregando");
            } else {
                status.setText("Faltam " + timeRemaning + " minutos para o carregamento completo");
            }
        }
    }
}